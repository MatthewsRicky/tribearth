...
function Location() {
	return <div className="flex md:flex-row flex-col p-4 m-8 items-center justify-between bg-emerald-300 shadow-2xl rounded-xl">
		...
		<div className="flex flex-col justify-between text-center md:text-left">
			...
			<div className="flex flex-col p-4 ">
				<button className='scale-80 text-bold text-white flex justify-center items-center bg-transparent border border-emerald-500 hover:bg-emerald-200 opacity-95 hover:scale-110 duration-200 text-center rounded-xl px-2 py-3 md:hover:scale-110 my-6 shadow-md'>DISCOVER MORE
